...
import { TextInput, Button, Accordion, Alert, Avatar, Card, Tooltip } from "flowbite-react";

interface UserCardInformationProps {
  name: string;
  position: string;
  description: string;
  isEdit: boolean;
...
const UserCardInformation: React.FC<UserCardInformationProps> = ({name, position, description, isEdit, setIsEdit}) => {
  return (
    <Tooltip content="Click the Pen to edit User Information">
    <Card className="items-left bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700" style={{minWidth: '550px', maxWidth: '550px'}} >
    <div className="p-4">
      <div className="flex justify-end">
        {/* Pencil Icon */}
        <a onClick={() => setIsEdit(true)} className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
